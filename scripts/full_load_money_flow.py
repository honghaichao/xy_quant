# ruff: noqa: E402
"""Full-load script for money_flow."""
...
def parse_args() -> Namespace:
    """Parse CLI arguments for the money_flow full-load script."""
    parser = argparse.ArgumentParser(description='Full load money_flow.')
...
def main() -> dict[str, int]:
    """Run the money_flow full-load job."""
    args = parse_args()
