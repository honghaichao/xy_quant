...
def parse_args() -> Namespace:
    """Parse CLI arguments for the finance full-load script."""
    parser = argparse.ArgumentParser(description='Full load finance.')
