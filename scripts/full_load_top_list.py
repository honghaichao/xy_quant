...
def parse_args() -> Namespace:
    """Parse CLI arguments for the top_list full-load script."""
    parser = argparse.ArgumentParser(description='Full load top_list.')
...
def main() -> dict[str, int]:
    """Run the top_list full-load job."""
    args = parse_args()
