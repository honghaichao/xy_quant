# ruff: noqa: E402
"""Incremental update script for basic."""
...
from scripts.update_helpers import build_logger, run_updater_job

logger = build_logger('basic')


def parse_args() -> Namespace:
    """Parse CLI arguments for the basic update script."""
    parser = argparse.ArgumentParser(description='Update basic.')
...
def main() -> dict[str, int]:
    """Run the basic incremental update job."""
    args = parse_args()
