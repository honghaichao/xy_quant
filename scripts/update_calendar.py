# ruff: noqa: E402
"""Incremental update script for calendar."""
...
def parse_args() -> Namespace:
    """Parse CLI arguments for the calendar update script."""
    parser = argparse.ArgumentParser(description='Update calendar.')
...
def main() -> dict[str, int]:
    """Run the calendar incremental update job."""
    args = parse_args()
