# ruff: noqa: E402
"""Incremental update script for margin."""
...
def parse_args() -> Namespace:
    """Parse CLI arguments for the margin update script."""
    parser = argparse.ArgumentParser(description='Update margin.')
...
def main() -> dict[str, int]:
    """Run the margin incremental update job."""
    args = parse_args()
