# ruff: noqa: E402
"""Incremental update script for suspend."""
...
from scripts.update_helpers import add_trade_date_argument, build_logger, run_updater_job

logger = build_logger('suspend')


def parse_args() -> Namespace:
    """Parse CLI arguments for the suspend update script."""
    parser = argparse.ArgumentParser(description='Update suspend.')
...
def main() -> dict[str, int]:
    """Run the suspend incremental update job."""
    args = parse_args()
