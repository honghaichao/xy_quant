# ruff: noqa: E402
"""Full-load script for index_daily."""
...
def parse_args() -> Namespace:
    """Parse CLI arguments for the index_daily full-load script."""
    parser = argparse.ArgumentParser(description='Full load index_daily.')
...
def main() -> dict[str, int]:
    """Run the index_daily full-load job."""
    args = parse_args()
