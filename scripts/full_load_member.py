...
def parse_args() -> Namespace:
    """Parse CLI arguments for the member full-load script."""
    parser = argparse.ArgumentParser(description='Full load member.')
