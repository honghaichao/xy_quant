# ruff: noqa: E402
"""Full-load script for limit_list."""
...
def parse_args() -> Namespace:
    """Parse CLI arguments for the limit_list full-load script."""
    parser = argparse.ArgumentParser(description='Full load limit_list.')
...
def main() -> dict[str, int]:
    """Run the limit_list full-load job."""
    args = parse_args()
