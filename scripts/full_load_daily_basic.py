# ruff: noqa: E402
"""Full-load script for daily_basic."""
...
def parse_args() -> Namespace:
    """Parse CLI arguments for the daily_basic full-load script."""
    parser = argparse.ArgumentParser(description='Full load daily_basic.')
...
def main() -> dict[str, int]:
    """Run the daily_basic full-load job."""
    args = parse_args()
